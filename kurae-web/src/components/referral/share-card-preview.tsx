...
type ShareCardPreviewBodyProps = {
  onClose: () => void;
  shareUrl: string;
  sellerSlug: string;
  dropSlug?: string;
...
function ShareCardPreviewBody({
  onClose,
  shareUrl,
  sellerSlug,
  dropSlug,
  code,
}: ShareCardPreviewBodyProps) {
...
export function ShareCardPreview({
  ...
  return (
    ...
    >
      {open ? (
        <ShareCardPreviewBody
          key={`${sellerSlug}-${dropSlug ?? ""}-${code}`}
          onClose={onClose}
          shareUrl={shareUrl}
